                                    ...
                                    <div className="nk-block nk-block-middle nk-auth-body">
                                        ...
                                        <div className="nk-block-head">
                                            <div className="nk-block-head-content">
                                                <h2 className="nk-block-title text-blue">Check your inbox</h2>
                                                <h2 className="nk-block-title text-gray">
                                                    {
                                                    currentuser ? currentuser.email : ''
                                                } </h2>
                                                <div>
                                                    <p className="text-center">A confirmation email has been sent to the email address above. Please click the verification link in the email to sign in</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
